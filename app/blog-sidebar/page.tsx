...
console.log(relatedPost);
  ...
  useEffect(() => {
    if (getProduct?.product) {
      setBlogData(getProduct?.product);
    }
    if (resPonseProfile) {
      setProfileData(resPonseProfile);
    }
  }, [getProduct, resPonseProfile]);

  if (getProductIsLoading || loadingProfile) {
    return <Loader />;
  }
                ...
                <div>
                  ...
                  <div className="mb-10 flex flex-wrap items-center justify-between border-b border-body-color border-opacity-10 pb-4 dark:border-white dark:border-opacity-10">
                    <div className="flex flex-wrap items-center">
                      ...
                      <div className="mb-5 flex items-center">
                        <p className="mr-5 flex items-center text-base font-medium text-body-color">
                          ...
                          {new Date(getBlogData.createdAt).toLocaleString()}
                        </p>
                        <p className="mr-5 flex items-center text-base font-medium text-body-color">
                          <span className="mr-3">
                            <svg
                    ...
                    <div className="mb-5">
                      ...
                      >
                        {getBlogData.category}
                      </p>
                    </div>
                  </div>
                  <div>
                    <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                      {getBlogData.imgIntro}
                    </p>
                    ...
                    <div className="items-center justify-between sm:flex">
                      <div className="mb-5">
                        ...
                        <div className="flex items-center">
                          {
                            getBlogData.tags.map((v, i) => (
                              <TagButton key={i} text={v} />
                            ))
                          }
                        </div>
                      </div>
